...
// Response Body
{
  "availability": {
    ...
    "provider": "alibaba",
    "queriedAt": "2026-09-08T05:26:46.097916548Z",
...
// Response Body
{
  ...
  "conditions": [
    {
      "lastTransitionTime": "2026-09-08T05:26:55Z",
      "reason": "Available",
      "status": "True",
      "type": "Ready"
    },
  ...
  "connectionName": "alibaba-ap-northeast-2",
  "cspResourceId": "vpc-mj74p4g4qnwnnkzk69fc5",
  "cspResourceName": "tb5fchapn6lm0aovbjj4",
  "description": "Pre-requisite VNet for CM-Beetle RDBMS test",
  ...
  "keyValueList": [
    ...
    {
      "key": "VpcId",
      "value": "vpc-mj74p4g4qnwnnkzk69fc5"
    },
    {
      "key": "IsDefault",
      "value": "false"
    ...
    {
      "key": "VpcName",
      "value": "tb5fchapn6lm0aovbjj4"
    },
    {
      "key": "VRouterId",
      "value": "vrt-mj7v8fd35j094xeia4yxy"
    },
    {
      "key": "CidrBlock",
      "value": "10.3.0.0/16"
    ...
    {
      "key": "VSwitchIds",
      "value": "{VSwitchId:[vsw-mj7dz44e5ocm5uzyaffh3]}"
    },
    {
    ...
    {
      "key": "RouterTableIds",
      "value": "{RouterTableIds:[vtb-mj7oaec6mqc8rp5mklf53]}"
    },
    {
      "key": "Tags",
      "value": "{Tag:null}"
  ...
  "subnetInfoList": [
    {
      ...
      "connectionName": "alibaba-ap-northeast-2",
      "cspResourceId": "vsw-mj7dz44e5ocm5uzyaffh3",
      "cspResourceName": "tbkldi9tvgm9e2qo8ol1",
      "cspVNetId": "vpc-mj74p4g4qnwnnkzk69fc5",
      "cspVNetName": "tb5fchapn6lm0aovbjj4",
      "description": "",
      "id": "subnet-1",
      "ipv4_CIDR": "10.3.1.0/24",
      "keyValueList": [
        ...
        {
          "key": "VSwitchId",
          "value": "vsw-mj7dz44e5ocm5uzyaffh3"
        },
        {
          "key": "CidrBlock",
          "value": "10.3.1.0/24"
        ...
        {
          "key": "RouteTable",
          "value": "{ResourceGroupId:,CreationTime:,Status:,RouteTableType:System,VRouterId:,RouteTableId:vtb-mj7oaec6mqc8rp5mklf53,VSwitchIds:{VSwitchId:null},RouteEntrys:{RouteEntry:null}}"
        },
        {
          "key": "Tags",
          "value": "{Tag:null}"
      ...
      "resourceType": "subnet",
      "status": "Available",
      "uid": "tbkldi9tvgm9e2qo8ol1",
      "zone": "ap-northeast-2a"
    }
  ],
  "systemLabel": "",
  "uid": "tb5fchapn6lm0aovbjj4"
}
```
...
// Response Body
{
  ...
  "connectionName": "alibaba-ap-northeast-2",
  "cspResourceId": "sg-mj76c89bevierxn6g6of",
  "cspResourceName": "tbg51s49maor2d1f5ivj",
  "description": "Pre-requisite SecurityGroup for CM-Beetle RDBMS test",
  "firewallRules": [
    {
      "CIDR": "0.0.0.0/0",
  ...
  "keyValueList": [
    {
      "key": "SecurityGroupId",
      "value": "sg-mj76c89bevierxn6g6of"
    },
    {
      "key": "SecurityGroupName",
      "value": "tbg51s49maor2d1f5ivj"
    },
    {
      "key": "Description",
      "value": "tbg51s49maor2d1f5ivj"
...
// Response Body
{
  ...
  "tagList": [
    ...
    },
    {
      ...
      "value": "rm-mj7e5k8a1l626j1lb"
    },
    {
      "key": "sys.cspResourceName",
      "value": "tbn0suh6d0ggvjt3g8gr"
    },
    {
      "key": "sys.description",
