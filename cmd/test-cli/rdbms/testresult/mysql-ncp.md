...
// Response Body
{
  ...
  "conditions": [
    {
      "lastTransitionTime": "2026-09-08T05:59:26Z",
      "reason": "Available",
      "status": "True",
      "type": "Ready"
    },
  ...
  "connectionName": "ncp-kr",
  "cspResourceId": "147713",
  "cspResourceName": "tbv2mrp5n5gqkjdruuq9",
  "description": "Pre-requisite VNet for CM-Beetle RDBMS test",
  ...
  "keyValueList": [
    ...
    {
      "key": "CreateDate",
      "value": "2026-09-08T14:58:58+0900"
    }
  ],
  "name": "test-rdbms-vnet-ncp",
  "resourceType": "vNet",
  ...
  "subnetInfoList": [
    {
      ...
      "connectionName": "ncp-kr",
      "cspResourceId": "322073",
      "cspResourceName": "tblq4vsekjptftoehmo2",
      "cspVNetId": "147713",
      "cspVNetName": "tbv2mrp5n5gqkjdruuq9",
      "description": "",
      "id": "subnet-1",
      "ipv4_CIDR": "10.7.1.0/24",
      "keyValueList": [
        ...
        {
          "key": "CreateDate",
          "value": "2026-09-08T14:59:12+0900"
        },
        {
          "key": "SubnetType",
      ...
      "resourceType": "subnet",
      "status": "Available",
      "uid": "tblq4vsekjptftoehmo2",
      "zone": "KR-1"
    }
  ],
  "systemLabel": "",
  "uid": "tbv2mrp5n5gqkjdruuq9"
}
```
...
// Response Body
{
  ...
  "connectionName": "ncp-kr",
  "cspResourceId": "393657",
  "cspResourceName": "tb2ljmrshpdehqkom91m",
  "description": "Pre-requisite SecurityGroup for CM-Beetle RDBMS test",
  "firewallRules": [
    {
      "CIDR": "0.0.0.0/0",
  ...
  "rdbms": [
    {
      ...
      "conditions": [
        {
          "lastTransitionTime": "2026-09-08T06:11:27Z",
